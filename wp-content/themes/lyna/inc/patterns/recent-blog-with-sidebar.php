 ...
 */
return array(
	'title'      => esc_html__( 'Recent Blog With Sidebar', 'lyna' ),
	'categories' => array( 'lyna', 'query' ),
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
<div class="wp-block-group alignfull"><!-- wp:columns {"align":"wide","className":"wp-block-sidebar-on-right"} -->
<div class="wp-block-columns alignwide wp-block-sidebar-on-right"><!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:query {"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","categoryIds":[],"tagIds":[],"order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"layout":{"inherit":true}} -->
...
<div class="wp-block-column wp-block-column-sidebar" style="flex-basis:25%">
    <!-- wp:template-part {"slug":"sidebar","tagName":"div","theme":"lyna"} /-->
</div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
