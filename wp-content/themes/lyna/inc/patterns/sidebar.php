 ...
 */
return array(
	'title'      => esc_html__( 'Sidebar', 'lyna' ),
	'categories' => array( 'lyna', 'featured', 'pages' ),
...
<div class="wp-block-group wp-block-widget-area wp-block-sidebar">
    ...
    <div class="wp-block-group wp-block-widget">
        ...
        <figure class="wp-block-image size-large"><img src="' . get_parent_theme_file_uri( '/assets/images/team-3.jpg' ) . '" alt="" /></figure>
        <!-- /wp:image -->
