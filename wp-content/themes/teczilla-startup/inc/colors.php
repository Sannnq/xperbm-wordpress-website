...
$teczilla_theme_color_scheme = get_theme_mod('teczilla_theme_color_scheme','#007cfb');
$teczilla_custom_css      = '';           
                              ...
                              <h2 class="banner-heading">
                                <?php if ( is_archive() ) {
                                 ...
                                 elseif(is_search()){
                                  ...
                                  echo  esc_html__('Search Results For ', 'teczilla-startup') . ' " ' . get_search_query() . ' "';

                                 }elseif ( is_404() ) {
                                  echo  esc_html__('Nothing Found ', 'teczilla-startup');
                                 }
                                 else{
