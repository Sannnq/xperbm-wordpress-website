...
<?php $teczilla_top_header_enable =  get_theme_mod('teczilla_top_header_enable',0); 
    ...
    ?>
            <div class="teczilla-menu-area menu-sticky <?php if(is_user_logged_in()) { ?> tec-startup-stick <?php } ?>">
                <?php } else { ?>
                <div class="menu-area">
                    <?php } ?> 
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-9 text-right">
                             <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Top Menu', 'teczilla-startup' ); ?>">
                            ...
                            wp_nav_menu( array(
                                ...
                                <ul class="teczilla-add-menu">
                                    <li class="header-menus">
                                        <a href="<?php echo esc_url( admin_url( 'nav-menus.php' ));  ?>"><?php echo esc_html__( 'Add Main Menu', 'teczilla-startup' ); ?>
                                        </a>
                                    </li>
                                </ul>
                                <?php
