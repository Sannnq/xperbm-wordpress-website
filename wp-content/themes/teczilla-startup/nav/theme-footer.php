                ...
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-12">
                            ...
                            <p>
                            <?php
                            printf( __( 'Proudly powered by', 'teczilla-startup' ) );
                            ?>

                            <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'teczilla-startup' ) ); ?>" class="imprint">
                            	
							<?php
                            printf( __( 'WordPress', 'teczilla-startup' ) );
                            ?>
                            </a>
